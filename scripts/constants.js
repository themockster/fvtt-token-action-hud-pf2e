...
export const SKILL_ACTION = {
    ...
    i95kcGLIQKOTsnv6: { name: 'PF2E.Actions.Grapple.Title', skill: 'athletics', actionCost: 1, image: 'icons/skills/melee/unarmed-punch-fist.webp' },
    ...
    vmoO2VasZyTgs3PH: { name: 'PF2E.Actions.Perform.Acting.Title', skill: 'performance', actionCost: 1, image: 'icons/skills/trades/music-singing-voice-blue.webp' },
    i6WwSpxDuV2jCwB4: { name: 'PF2E.Actions.Perform.Comedy.Title', skill: 'performance', actionCost: 1, image: 'icons/skills/trades/music-singing-voice-blue.webp' },
    PgA74rWIAupEr7LU: { name: 'PF2E.Actions.Perform.Dance.Title', skill: 'performance', actionCost: 1, image: 'icons/skills/trades/music-singing-voice-blue.webp' },
    Om0rNX4K3pQcXDJn: { name: 'PF2E.Actions.Perform.Oratory.Title', skill: 'performance', actionCost: 1, image: 'icons/skills/trades/music-singing-voice-blue.webp' },
    Bw3rSN774LaHLELJ: { name: 'PF2E.Actions.Perform.Keyboards.Title', skill: 'performance', actionCost: 1, image: 'icons/skills/trades/music-singing-voice-blue.webp' },
    UoRM6ZMhhhjz1vu8: { name: 'PF2E.Actions.Perform.Percussion.Title', skill: 'performance', actionCost: 1, image: 'icons/skills/trades/music-singing-voice-blue.webp' },
    nvpRlDKUD4SjZaJ0: { name: 'PF2E.Actions.Perform.Strings.Title', skill: 'performance', actionCost: 1, image: 'icons/skills/trades/music-singing-voice-blue.webp' },
    HQrDnBbbSCQEXrSb: { name: 'PF2E.Actions.Perform.Winds.Title', skill: 'performance', actionCost: 1, image: 'icons/skills/trades/music-singing-voice-blue.webp' },
    dWcrojMk0d2WRPBq: { name: 'PF2E.Actions.Perform.Singing.Title', skill: 'performance', actionCost: 1, image: 'icons/skills/trades/music-singing-voice-blue.webp' },
    ...
    gzTJWA5vJkZI9Gj5: { name: 'PF2E.Actions.Reposition.Title', skill: 'athletics', actionCost: 1, image: 'icons/skills/melee/unarmed-punch-strength.webp' },
